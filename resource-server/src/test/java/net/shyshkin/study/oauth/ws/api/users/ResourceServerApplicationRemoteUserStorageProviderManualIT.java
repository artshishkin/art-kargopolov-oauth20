...
@Disabled("Only for manual testing - Start keycloak-postgres-remote-user-storage-provider docker compose file")
@Testcontainers
...
class ResourceServerApplicationRemoteUserStorageProviderManualIT {

    public static final String RESOURCE_OWNER_USERNAME = "test2@test.com";
    public static final String RESOURCE_OWNER_PASSWORD = "art";
